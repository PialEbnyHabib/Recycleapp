...
void main() => runApp(ElectronicDevices());
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                "Dear user, your unused, disposable elctronic devices can be recycled. For only 50 taka a bag, we will collect your recyclables from your door, on demand. Recycling couldn't be easier!",
                style: TextStyle(
