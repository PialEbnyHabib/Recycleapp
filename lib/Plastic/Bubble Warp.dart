...
void main() => runApp(BubbleWrap());

class BubbleWrap extends StatelessWidget {
  @override
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                "Dear user, your unused Bubble Wrap can be recycled. For only 50 taka a bag, we will collect your recyclables from your door, on demand. Recycling couldn't be easier!",
                style: TextStyle(
